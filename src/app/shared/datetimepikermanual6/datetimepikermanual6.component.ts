...
@Component({
  selector: 'app-datetimepikermanual6',
  templateUrl: './datetimepikermanual6.component.html',
  styleUrls: ['./datetimepikermanual6.component.scss']
})
export class Datetimepikermanual6Component implements OnInit {
